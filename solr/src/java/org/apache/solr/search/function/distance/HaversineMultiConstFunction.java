...
public class HaversineMultiConstFunction extends ValueSource {
  ...
  @Override
  public DocValues getValues(Map context, IndexReader.AtomicReaderContext ctx) throws IOException {
    final GeoHashValueSource.GeoHashDocValues ghDocVals = vs.getValues(context, ctx);
