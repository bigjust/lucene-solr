...
public class GridNode {
  ...
  public static class GridReferenceSystem {
    ...
    public Point2D decodeXY(BytesRef term) {
      double[] latLon = GeoHashUtils.decode(term.utf8ToString());
  ...
  private final BytesRef thisTerm;
  private final Rectangle rect;

  private GridNode(GridReferenceSystem refSys, BytesRef byteRef, Rectangle rect) {
    this.refSys = refSys;
    this.rect = rect;
